...
#     "hindi": {"name": "नाम", "desc": "विवरण", "cause": "कारण", "treat": "उपचार", "advice": "सलाह", "msg": "आपको डॉक्टर سے मिलना चाहिए।"},
...
#     # Detect Language (Default is Urdu)
#     selected_lang = "urdu"
...
#     found_disease = "fever" # Default if no match
#     if "cough" in symptoms or "khansi" in symptoms or "کھانسی" in symptoms:
#         found_disease = "flu"

#     disease_info = DISEASES.get(found_disease, DISEASES['fever'])
    
#     # Fallback to English if language not in disease specific dict
#     lang_content = disease_info.get(selected_lang, disease_info['urdu'])
#     labels = LANG_DATA[selected_lang]

#     # Age advice
#     if age < 12: age_msg = "بچوں کے لیے خاص احتیاط کی ضرورت ہے۔" if selected_lang=="urdu" else "Special care for kids."
#     elif age > 60: age_msg = "بزرگوں کے لیے فوری چیک اپ ضروری ہے۔" if selected_lang=="urdu" else "Immediate checkup for elderly."
#     else: age_msg = "مناسب آرام اور غذا لیں۔" if selected_lang=="urdu" else "Take proper rest."
